...
function _M:display()
	...
	self:makeTexture(("#AQUAMARINE#Dreaming: #LAST#%d   "):format(player.dreaming.dice), w * 0.03, h * 0.05)
	
	self:makeTexture(("#STEEL_BLUE#Reason:   #LAST#%d   "):format(player.reason.dice), w * 0.03, h * 0.09)
